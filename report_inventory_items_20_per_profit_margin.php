...
// function arr_sort($DT_array, $srt_sort, $srt_order)
// {
...
//         foreach ($DT_array as $MGArraytmp) {
...
//             array_multisort($MGArraysort_I, SORT_ASC, SORT_NUMERIC, $DT_array);

//         }

//         if ($srt_order == "DESC") {

//             array_multisort($MGArraysort_I, SORT_DESC, SORT_NUMERIC, $DT_array);

//         }

//     }

//     if ($srt_sort == "description") {

//         $MGArraysort_I = array();

//         foreach ($DT_array as $MGArraytmp) {

//             $MGArraysort_I[] = $MGArraytmp['A'];

//         }

//         if ($srt_order == "ASC") {

//             array_multisort($MGArraysort_I, SORT_ASC, SORT_STRING, $DT_array);

//         }

//         if ($srt_order == "DESC") {

//             array_multisort($MGArraysort_I, SORT_DESC, SORT_STRING, $DT_array);

//         }

//     }

//     if ($srt_sort == "warehouse") {

//         $MGArraysort_I = array();

//         foreach ($DT_array as $MGArraytmp) {

//             $MGArraysort_I[] = $MGArraytmp['WH_Name'];
...
//     if ($srt_sort == "supplier") {

//         $MGArraysort_I = array();

//         foreach ($DT_array as $MGArraytmp) {

//             $MGArraysort_I[] = $MGArraytmp['Supp_Name'];
...
//             $MGArraysort_I[] = $MGArraytmp['porfit'];
...
//             $MGArraysort_I[] = $MGArraytmp['pLoad'];
...
//             $MGArraysort_I[] = $MGArraytmp['margin'];
