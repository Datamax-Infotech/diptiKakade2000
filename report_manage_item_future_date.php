...
<head>
	...
	<title>Items with Future Ship Dates Report</title>
...
<div class="main_data_css">
	...
	<div class="dashboard_heading" style="float: left;">
		...
		<div style="float: left;">
			...
			Items with Future Ship Dates



			<div class="tooltip"><i class="fa fa-info-circle" aria-hidden="true"></i>

			<span class="tooltiptext">This report will help Sourcing team to check what are the items that have future delivery dates. In that way they can follow up with there respective Suppliers.</span></div><br>
	...
	<div class="report_manage_future_date_filter">

		Select Timing:

		<select class="basic_style" name="g_timing" id="g_timing" onchange="gettimingdata(this.value)">

			<option value="">Please select value</option>

			<option value="1">Can ship in 2 weeks</option>

			<option value="2">Can ship immediately</option>

			<option value="3">Can ship this month</option>

			<option value="4">Can ship next month</option>

			<option value="5">Ready to ship whenever</option>

			<option value="6">Enter ship by date</option>

		</select>

		<input type="date" id="g_timing_enter_dt" name="g_timing_enter_dt" value="" placeholder="mm/dd/yyyy" style="width: 120px; display: none;">

		<input type="button" id="g_timing_enter_dt_btn" name="g_timing_enter_dt_btn" value="Load" onclick="getTableData(document.getElementById('g_timing_enter_dt').value)" style="display: none;">
	...
	<div id="future_report_table_data">
...
if ($no_of_rec == 0) {?>
    ...
    $sorturl = "report_manage_item_future_date.php?id=" . $_REQUEST['id'] . "&sort_order=";
...
<script>
	...
	function getTableData(data){
		...
		if(data != ''){
			...
			document.getElementById("future_report_table_data").innerHTML = "Loading .....<img src='images/wait_animated.gif' />";
			...
			xmlhttp.onreadystatechange=function(){
				...
				if (xmlhttp.readyState==4 && xmlhttp.status==200){
					...
					document.getElementById("future_report_table_data").innerHTML = xmlhttp.responseText;
			...
			xmlhttp.open("GET","report_manage_item_future_date_table_data.php?date="+data,true);
